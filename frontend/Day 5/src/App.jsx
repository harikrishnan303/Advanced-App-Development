...
import MainContent from "./Pages/Crud/MainContent";
	...
	return (
		<>
			...
			<Routes>
					...
					<Route path="/admindashboard" element={<MainContent />}></Route>
					<Route path="/admincrud" element={<Crud />}></Route>
					
					<Route path="/adminapplications" element={<Applications />}></Route>
